...
var ewdDOM = {
  ...
  getNextDOMNo: function() {
    var gnode = {global: ewdDOM.global, subscripts: ['dom','']};
    var previous = ewdDOM.db.previous(gnode);
    if (previous.result === '') return 1;
    return parseInt(previous.result) + 1;
  },
  ...
  incrementNodeNo: function(docId) {
    var node = {global: ewdDOM.global, subscripts: ['dom', docId, 'node']};
